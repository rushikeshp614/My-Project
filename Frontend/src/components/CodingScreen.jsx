...
function CodingScreen() {
    ...
    //     if (randomQuestionData && randomQuestionData.key && Array.isArray(exerciseData)) {

    //         const matchingExercise = exerciseData.find((exercise) =>
    //             exercise.questions.some((question) => question.key === randomQuestionData.key)
    //         );

    //         if (matchingExercise && matchingExercise.solutions) {
    //             const matchingSolution = matchingExercise.solutions.find(
    //                 (solution) => solution.key === randomQuestionData.key
    //             );
                        ...
                        <details>
                            ...
                            {/* <div className="code-toolbar">
                                <div class="gb-accordion-text">
                                    <pre className="wp-block-code language-python">
                                        <code className="language-python">{sampleSolution}</code>
                                    </pre>
                                </div>
                                </div> */}
                            <AceEditor
